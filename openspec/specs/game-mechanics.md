...
ダッシュは全ヒーロー共通ではなく、ヒーロー固有のスキルとして実装されている。タレントツリーで習得し、スキルスロット（Q/E/R）に割り当てて使用する。

- **BLADE — Charge（Q）:** 前方ダッシュ + ダメージ。**Dodge Roll（タレント）:** 無敵フレーム付き短距離ダッシュ。
- **BOLT — Dash（Q）:** 高速回避ダッシュ。
